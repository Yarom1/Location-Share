...
class LocationService : Service() {
    ...
    private val DM_CHANNEL_ID = "dm_chat"
    private var lastMessageCheckTime: String? = null
    private val dmLastCheckTimes = mutableMapOf<String, String>()
    ...
    private fun checkForNewDmMessages(uid: String, idToken: String, prefs: android.content.SharedPreferences) {
